...
NISHU YADAV
Delhi, India
nishu.yadav@email.com | +91 9876543210
LinkedIn: linkedin.com/in/nishuyadav | GitHub: github.com/nishuyadav
PROFESSIONAL SUMMARY
MERN Stack Developer with 3+ years of experience building scalable web applications, mainly focused on backend development using Node.js and MongoDB. I have worked on building REST APIs, implementing authentication using JWT, and optimizing database queries.
TECHNICAL SKILLS
...
Optimized MongoDB queries using indexing and aggregation pipelines, reducing query time significantly
...
const jobDescription = `JOB DESCRIPTION — ROLE APPLIED FOR
